...
/* harmony import */ var _helpers_exec_spell_command__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(87885);
...
var SpeechRecognizeNative = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__extends */ .ZT)(SpeechRecognizeNative, _super);
    ...
    SpeechRecognizeNative.prototype._checkCommand = function (command) {
        ...
        if (this._commandToWord[command]) {
            (0,_helpers_exec_spell_command__WEBPACK_IMPORTED_MODULE_10__/* .execSpellCommand */ .c)(this.j, this._commandToWord[command]);
            return true;
        }
        return false;
    };
